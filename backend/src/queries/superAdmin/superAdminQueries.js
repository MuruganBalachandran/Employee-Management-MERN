...
const createAdmin = async (payload = {}) => {
  try {
    ...
    throw new Error("Error while while perform create admin", err);
  }
};
// endregion
...
const getAllAdmins = async (limit = 20, skip = 0, search = "") => {
  try {
    ...
    throw new Error("Error while perform get all admins", err);
  }
};
// endregion
...
const getAdminById = async (id = "") => {
  try {
    ...
    throw new Error("Error while perform get admin by id", err);
  }
};
// endregion
...
const deleteAdmin = async (adminId = "") => {
  try {
    ...
    throw new Error("Error while perform delete admin", err);
  }
};
// endregion
